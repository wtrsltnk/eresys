...
namespace Eresys
{
    ...
    public class DxGraphics : IGraphics
    {
        ...
        public DxGraphics()
        {
            ...
            // Log
            Logger.Log(LogLevels.Info, "Initialising graphics...");
            Logger.Log(LogLevels.Info, "  Display Mode:       " + width + "x" + height + "x" + depth + " " + (fullscreen ? "fullscreen" : "windowed"));
            Logger.Log(LogLevels.Info, "  Using HAL:          " + (hal ? "yes" : "no (software emulation with Microsoft DirectX Reference Driver)"));
            Logger.Log(LogLevels.Info, "  Using hardware T&L: " + (tnl ? "yes" : "no"));
