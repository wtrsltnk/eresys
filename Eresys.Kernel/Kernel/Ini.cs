...
namespace Eresys
{
    ...
    public class Ini
    {
        ...
        public Ini(string iniFileName)
        {
            ...
            {
                _iniFileName = System.AppDomain.CurrentDomain.BaseDirectory + "\\" + iniFileName;
            }
        }
        ...
        {
            WritePrivateProfileString(section, key, val, _iniFileName);
        }
        ...
        public string Read(string section, string key)
        {
            ...
            int i = GetPrivateProfileString(section, key, "", temp, 1024, _iniFileName);
